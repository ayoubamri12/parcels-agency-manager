...
.dt-buttons .buttons-excel {
    background-color: purple !important; /* Blue for Excel */
        ...
        buttons: [
            {
                ...
                customize: function(xlsx) {
                    // Optional: Modify the Excel file (add custom styles or sheets)
                    var sheet = xlsx.xl.worksheets['sheet1.xml'];
                    // Example: Change the cell background color
                }
            }
        ],
    paging: true,
